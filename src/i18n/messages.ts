...
const en = {
  ...
  "sidebar.sessionNeedsAttention": "Needs your choice — open to answer",
...
"media.loadError": "Could not load this media in the app preview.",
  ...
  "composer.queueEdit": "Edit queued prompt",
  "composer.queueEditLoaded": "Loaded into composer — edit and send again",
...
const zh: Record<MessageKey, string> = {
  ...
  "sidebar.sessionNeedsAttention": "需要你选择 — 点开回答",
...
"media.loadError": "应用内无法加载此媒体。",
  ...
  "composer.queueEdit": "编辑待发提示词",
  "composer.queueEditLoaded": "已载入输入框 — 修改后再次发送",
